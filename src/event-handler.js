import { updateGPA, updateGradeColor, initSubjectEntry, CourseManager } from "./utils.js";
...
export function handleEntryDelete(e) {
    ...
    CourseManager.deleteCourse(currentTarget.parentElement.getAttribute("course-id"));
