...
export function appendSubjectEntry({
    ...
    newSubjectEntry.querySelector(".delete-button").addEventListener("click", handleEntryDelete);
...
export class CourseManager {
    ...
    static saveToStorage() {
        try {
            localStorage.setItem(CourseManager.#STORAGE_KEY, JSON.stringify(this.courses));
        } catch (error) {
...
export function updateGPA() {
    ...
    const classCredits = document.querySelectorAll(".subject-entry .class-credit");
